...
class View:
    ...
    def __init__(self, map, device, version=-1):
        ...
        self.useUiAutomator = False#(version >= 16)
...
class ViewClient:
    ...
    def __init__(self, device, serialno, adb=None, autodump=True, localport=VIEW_SERVER_PORT, remoteport=VIEW_SERVER_PORT, startviewserver=True):
        ...
        self.useUiAutomator = False#(self.build[VERSION_SDK_PROPERTY] >= 16) # jelly bean 4.1 & 4.2
    ...
    def __obtainAdbPath():
        ...
        for exeFile in possibleChoices:
            #if os.access(exeFile, os.X_OK):#Excluir comentario para voltar ao original
            return exeFile
